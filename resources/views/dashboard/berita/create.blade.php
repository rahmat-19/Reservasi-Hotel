...
<div class="card shadow mb-4">
    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
        <h6 class="m-0 font-weight-bold text-primary">Tambah Kontent Berita</h6>
    </div>
        ...
        <form action="{{Route('berita.store')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <select class="form-select @error('kategori_berita_id') is-invalid @enderror" id="kategori_berita_id" name="kategori_berita_id" aria-label="Default select example">
                    ...
                    @if(old('kategori_berita_id') == $kategori->id)
            ...
            <div class="mb-3">
                ...
                <input type="date" name="tgl_post" id="tgl_post" value="{{old('tgl_post')}}" class="form-control @error('tgl_post') is-invalid @enderror">
                @error('tgl_post')
            ...
            <div class="mb-3">
                ...
                <input id="fasilitas" value="{{old('berita')}}" type="hidden" name="berita" class="@error('berita') is-invalid @enderror">
